...
public class InheritanceState {
    ...
    static final class ElementsToProcess {
        ...
        private ElementsToProcess(List<PropertyData> properties, int idPropertyCount) {
            // 复制数组 到propertyData
            List<PropertyData> propertyData = new ArrayList<>(properties);
            List<PropertyData> afterPropertyData =  properties.subList(1, 5);
            propertyData.removeAll(afterPropertyData);
            propertyData.addAll(afterPropertyData);
